...
public static class DependencyInjection
{
        ...
        this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // Caching — SizeLimit caps entries (not bytes); each cache Set must
        // specify Size = 1 or use the default (which counts as 0 against the
        // limit). 256 entries covers ~30 users * (1 daily + 4 weekly) with
        // headroom, preventing unbounded growth from arbitrary weekOf values.
