...
public sealed class CompleteDelegationHandler(
    IDelegationRepository delegationRepository,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
{
    public async Task<DelegationResponse> HandleAsync(
        Guid delegationId, CompleteDelegationRequest request, CancellationToken cancellationToken)
    {
        ...
        delegation.MarkCompleted(request.Notes);
