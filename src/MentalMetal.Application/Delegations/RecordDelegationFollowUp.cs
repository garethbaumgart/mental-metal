...
public sealed class RecordDelegationFollowUpHandler(
    IDelegationRepository delegationRepository,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
{
    public async Task<DelegationResponse> HandleAsync(
        Guid delegationId, FollowUpDelegationRequest request, CancellationToken cancellationToken)
    {
        ...
        delegation.RecordFollowUp(request.Notes);
