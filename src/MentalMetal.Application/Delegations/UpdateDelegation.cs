...
public sealed class UpdateDelegationHandler(
    IDelegationRepository delegationRepository,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
{
    public async Task<DelegationResponse> HandleAsync(
        Guid delegationId, UpdateDelegationRequest request, CancellationToken cancellationToken)
    {
        ...
        delegation.UpdateDescription(request.Description);
