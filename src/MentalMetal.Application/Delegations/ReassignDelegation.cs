...
public sealed class ReassignDelegationHandler(
    IDelegationRepository delegationRepository,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
{
    public async Task<DelegationResponse> HandleAsync(
        Guid delegationId, ReassignDelegationRequest request, CancellationToken cancellationToken)
    {
        ...
        delegation.Reassign(request.DelegatePersonId);
