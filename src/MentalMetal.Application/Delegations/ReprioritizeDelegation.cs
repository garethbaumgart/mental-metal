...
public sealed class ReprioritizeDelegationHandler(
    IDelegationRepository delegationRepository,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
{
    public async Task<DelegationResponse> HandleAsync(
        Guid delegationId, ReprioritizeDelegationRequest request, CancellationToken cancellationToken)
    {
        ...
        delegation.Reprioritize(request.Priority);
