...
public sealed class BlockDelegationHandler(
    IDelegationRepository delegationRepository,
    ICurrentUserService currentUserService,
    IUnitOfWork unitOfWork)
{
    public async Task<DelegationResponse> HandleAsync(
        Guid delegationId, BlockDelegationRequest request, CancellationToken cancellationToken)
    {
        ...
        delegation.MarkBlocked(request.Reason);
