...
public sealed class RecordInterviewDecisionHandler(
    ...
    TimeProvider timeProvider)
{
    public async Task<InterviewResponse> HandleAsync(
        Guid id, RecordInterviewDecisionRequest request, CancellationToken cancellationToken)
    {
        ...
        interview.RecordDecision(request.Decision, timeProvider.GetUtcNow());
