...
AI provider abstraction layer enabling BYO API key configuration, multi-provider completion (Anthropic, OpenAI, Google), taste key trial system, model fallback chains, and frontend nudge framework.
