...
Extensions to the user-auth-tenancy capability for AI provider integration — optional AI provider configuration on the User aggregate and AI provider status in the user profile response.
